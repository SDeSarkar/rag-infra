...
# ── Firewall — allow Container App Environment static outbound IP ─────────────
# Uses CAE static_ip_address — stable across revisions and redeployments
# Same IP used for PostgreSQL firewall rule
